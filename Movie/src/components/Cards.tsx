    ...
    <div className="max-w-sm flex bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-900 dark:border-gray-700">
      <a href="#">
        <img
          ...
          src="https://image.tmdb.org/t/p/original/wigZBAmNrIhxp2FNGOROUAeHvdh.jpg"
          alt=""
        />
      </a>
      <div className="p-5 h-60 w-70 flex flex-wrap justify-center">
        ...
        <div className="flex place-items-center gap-5 mt-auto">
          <a
            href="#"
            className="inline-flex items-center h-10 w-20 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            See more
          </a>
